...
file = open("/root/platziCourses/Python_Courses/python_Compre_Funct_Err-Hand/Mod_5_Python_Files_Errors/text.txt","r",)  # se crea una variable llamada file, y open abre el archivo con la ruta especificada, el segundo argumento es el modo de apertura, en este caso 'r' para lectura
...
for line in open("/root/platziCourses/Python_Courses/python_Compre_Funct_Err-Hand/Mod_5_Python_Files_Errors/text.txt","r",):
    print(line) 
...
with open("/root/platziCourses/Python_Courses/python_Compre_Funct_Err-Hand/Mod_5_Python_Files_Errors/text.txt") as file:
    for line in file:
        print(line)