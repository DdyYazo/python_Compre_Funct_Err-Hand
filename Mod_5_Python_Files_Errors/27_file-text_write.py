...
with open("/root/platziCourses/Python_Courses/python_Compre_Funct_Err-Hand/Mod_5_Python_Files_Errors/text.txt","r+",) as file: # En este caso se le asignan al archivo permisos de lectura y escritura para que no se sobreescriba el archivo
    for line in file:
        print(line)
...
with open("/root/platziCourses/Python_Courses/python_Compre_Funct_Err-Hand/Mod_5_Python_Files_Errors/text.txt","w+",) as file: # En este caso se le asignan al archivo permisos de lectura y escritura para que se sobreescriba el archivo
    for line in file:
        print(line)
    file.write("Hola, este es un archivo de texto\n")
